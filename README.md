...
VinTask solves this by scheduling continuations through queues that are drained by the game's own render and tick loops. Your code resumes on the thread it started on, at a timing you control.
